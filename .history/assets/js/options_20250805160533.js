...
(function() {
  ...
  function loadColors() {
    try {
      ...
      console.error('Помилка при читанні локального сховища:', e);
    }
  ...
  function saveColors(colors) {
    try {
      ...
      console.log('Збережено кольори:', colors);
    } catch (e) {
      console.error('Помилка при збереженні в локальне сховище:', e);
    }
  }
  ...
  function applyColors(colors) {
    ...
    console.log('Застосовано кольори:', colors);
  }
  ...
  function init() {
    ...
    if (!accentInput || !textInput || !backgroundInput) {
      console.warn('Колірні пікери не знайдені у DOM!');
      return;
    }
