...
// Додай в components новий скрипт після options.js
const components = [
  // ... інші компоненти ...
  {
  ...
  {
    id: 'custom-colors-placeholder',
    htmlPath: './components/empty.html',  // порожній файл, якщо потрібно
    scriptPath: './assets/js/custom-colors.js'
  },
  // ...
];
