...
function initOptionsControls() {
  ...
  // Пікери
  const accentColorPicker = document.getElementById('colorAccentPicker');
  const backgroundColorPicker = document.getElementById('colorBackgroundPicker');
  const textColorPicker = document.getElementById('colorTextPicker');

  // Кнопки скидання
  const accentResetBtn = document.getElementById('colorAccentResetBtn');
  const backgroundResetBtn = document.getElementById('colorBackgroundResetBtn');
  const textResetBtn = document.getElementById('colorTextResetBtn');
