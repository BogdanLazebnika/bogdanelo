function saveUser Setting(key, value) {
  ...
  applyUser Settings(); // Застосування налаштувань
...
document.addEventListener('DOMContentLoaded', () => {
  applyUser Settings(); // Застосування налаштувань при завантаженні
...
yesBtn.addEventListener('click', () => {
  ...
  applyUser Settings(); // Застосування стандартних налаштувань
  refreshActiveButtons();
