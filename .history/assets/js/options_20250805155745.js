...
function applyUserSettings() {
  ...
  if (settings.textColor) {
    ...
    if (picker) picker.value = settings.textColor;
  }
  ...
  if (settings.backgroundColor) {
    ...
    if (picker) picker.value = settings.backgroundColor;
  }
}

document.addEventListener('DOMContentLoaded', () => {
  // Прив'язка зміни кольорів
  ...
  if (accentReset) {
    accentReset.addEventListener('click', () => updateUserSetting('accentColor', undefined));
  }

  if (textReset) {
    textReset.addEventListener('click', () => updateUserSetting('textColor', undefined));
  }

  if (backgroundReset) {
    backgroundReset.addEventListener('click', () => updateUserSetting('backgroundColor', undefined));
  }
});
