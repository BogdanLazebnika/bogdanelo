...
function updateActiveButtons() {
  ...
  buttons.forEach(button => {
    ...
    // Парсимо key і value з рядка onclick
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Завантаження кольорів з локального сховища
  loadColorSettings();
});
...
// Додайте обробники для кнопок скидання кольорів
...
// Додайте обробники для скидання всіх налаштувань
const resetBtn = document.getElementById('resetAllSettingsBtn');
const modal = document.getElementById('confirmResetModal');
const yesBtn = document.getElementById('confirmResetYes');
const noBtn = document.getElementById('confirmResetNo');
