...
function showPanel() {
  // Прибираємо display:none
  panel.classList.remove('hidden');
  // Даємо браузеру "підхопити" зміни
  requestAnimationFrame(() => {
    panel.classList.remove('hide-animation');
  });
}

function hidePanel() {
  // Додаємо клас анімації зникнення
  panel.classList.add('hide-animation');

  // Чекаємо, поки анімація закінчиться, і ховаємо display:none
